% Unofficial UPenn Poster Template
% https://github.com/Qifei-C/gemini-upenn
% a fork of https://github.com/anishathalye/gemini
% also refer to https://github.com/andiac/gemini-cam
...
% logo: https://branding.web-resources.upenn.edu/logos-and-branding/download-penn-logos

\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      \node [anchor=north west, inner sep=3cm] at ([xshift=0.0cm,yshift=1.0cm]current page.north west)
      {\includegraphics[height=4.5cm]{logos/UPenn-white-logo.eps}}; 
    \end{tikzpicture}
}
